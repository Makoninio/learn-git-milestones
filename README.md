...
2 | 3-2 | Link to `commit #1 from Github.com` | [commit #1 from Github.com](https://github.com/Makoninio/learn-git-milestones/commit/00c4e424b0d0aaa4edd877c1f4d3896ecac83b92)
3 | 3-3 | Link to markdown tables docs | https://www.geeksforgeeks.org/html/markdown-tables/
4 | 3-4 | What does `log` do? | Lists all commits within a Git repository
...
10 | 7-1 | Link to `first-website` github.io "project site" | https://makoninio.github.io/first-website/ 
...
Row | Step | Description | Completed
--- | --- | --- | ---
11 | 8-1 | What is in Owen's dev branch? | Music video of Never Gonna Give You Up by Rick Astley
12 | 9-1 | Link to your new branch on github.com | https://github.com/Makoninio/learn-git-milestones/tree/tanaka-changes
13 | 10-1 | Link to your network graph | https://github.com/Makoninio/learn-git-milestones/network
14 | 11-1 | Link to the PR you made on a partner's github.com repo | https://github.com/anushrimodi/first-website/pull/2
